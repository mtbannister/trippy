...
def writeSex(fileName='def.sex', paramFileName='def.param', minArea=20, threshold=8, zpt=27.4, saturate=40000.,
    ...
    strArr = ['# Default configuration file for SExtractor 2.3b2 modded by Fraser',
              ...
              'PHOT_AUTOPARAMS ' + str(kron_factor) + ' ' + str(
                  min_radius) + '        # MAG_AUTO parameters: <Kron_fact>,<min_radius>',
              ' ',
...
if __name__ == "__main__":
    ...
    writeSex(fileName='test.sex', paramFileName='test.param', minArea=20, threshold=5, zpt=21.5, saturate=45000.,
             aperture=11)
